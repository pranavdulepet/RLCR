#!/bin/bash
#SBATCH --job-name=rlvr-hotpot
#SBATCH --partition=brtx6
#SBATCH --gpus=4
#SBATCH --time=23:59:59
#SBATCH --output=/srv/local1/%u/logs/rlvr-hotpot-%j.out
#SBATCH --error=/srv/local1/%u/logs/rlvr-hotpot-%j.err
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G

# RLVR HotpotQA Training Job for BRTX Cluster
# Usage: sbatch train_rlvr_hotpot_brtx.sh

set -e

echo "🚀 Starting RLVR HotpotQA Training on BRTX"
...
mkdir -p $USER_SCRATCH/outputs/RLVR-hotpot
...
# Create RLVR config for BRTX
cat > ./configs/RLVR_hotpot_brtx.yaml << 'EOF'
# RLVR HotpotQA Config for BRTX Cluster  
model_name_or_path: Qwen/Qwen2.5-7B
run_name: "RLVR-hotpot-brtx"
output_dir: /srv/local1/pdulepe1/outputs/RLVR-hotpot
model_revision: main
...
echo "✅ RLVR HotpotQA training completed!"

# Clean up
rm -f deepspeed_brtx.yaml

echo "📊 Training outputs saved to: $USER_SCRATCH/outputs/RLVR-hotpot"